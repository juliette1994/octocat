...
void  create_mapb1(int jx, int jy) {
  static char tab[taillebl][taillebc] = {{'#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#'},
				                         {' ',' ','#',' ',' ',' ','#',' ',' ',' ',' ',' ',' ','#',' ',' ',' ',' ',' ',' ',' ','#',' ','#','#',' ',' ',' ','#',' ',' ',' ',' ',' ','#',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ','#','#',' ',' ',' ',' ',' ',' ',' ','#','#','#',' ','#'},
				                         {'#',' ',' ',' ','#',' ',' ',' ','#','#','#',' ','#',' ','#','#','#','#','#','#',' ',' ',' ','#',' ',' ','#',' ','#',' ','#','#','#',' ','#','#',' ','#','#','#',' ','#',' ','#','#',' ',' ',' ','#',' ','#','#','#','#',' ','#',' ',' ',' ','#'},
				                         {'#',' ','#',' ',' ','#','#',' ',' ',' ','#',' ','#',' ','#',' ',' ',' ',' ','#',' ','#','#','#','#',' ','#',' ',' ',' ',' ',' ','#',' ','#',' ',' ','#',' ','#',' ','#',' ','#',' ',' ','#',' ','#',' ','#',' ',' ','#',' ','#','#',' ','#','#'},
				                         {'#',' ','#',' ','#',' ',' ',' ','#','#','#',' ',' ',' ','#',' ','#','#','#','#',' ',' ',' ',' ',' ',' ','#','#','#','#','#','#','#',' ','#',' ','#','#',' ','#',' ','#',' ','#',' ','#','#',' ','#',' ','#','#',' ',' ',' ',' ',' ',' ',' ','#'},
  ...
  tab[jy][jx] = ' ';
  move_mapb1_casu(tab, jy, jx, bouge);
}

void  create_mapb2(int jx, int jy) {
static char tab1[taillebl][taillebc] = {{'#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#'},
				                         {' ',' ','#',' ',' ',' ','#',' ',' ',' ','#',' ',' ','#',' ',' ',' ',' ',' ',' ',' ','#',' ','#','#',' ',' ',' ','#',' ',' ',' ',' ',' ','#',' ',' ',' ',' ',' ',' ',' ',' ','#',' ',' ','#','#',' ',' ',' ',' ',' ',' ',' ','#','#','#',' ','#'},
				                         {'#',' ',' ',' ','#',' ',' ',' ','#','#','#',' ','#',' ','#','#',' ','#','#','#',' ',' ',' ','#',' ',' ','#',' ','#',' ','#','#','#',' ','#','#',' ','#','#','#',' ','#',' ','#','#',' ',' ',' ','#',' ','#','#','#','#',' ','#',' ',' ',' ','#'},
				                         {'#',' ','#',' ',' ','#','#',' ',' ',' ','#',' ','#',' ','#',' ',' ',' ',' ','#',' ','#','#','#','#',' ','#',' ',' ','#',' ',' ','#',' ','#',' ',' ','#',' ','#','#','#',' ','#',' ','#','#',' ','#',' ','#',' ',' ','#',' ','#','#',' ','#','#'},
				                         {'#',' ','#','#','#',' ','#',' ','#','#','#',' ',' ',' ','#',' ','#','#','#','#',' ',' ',' ',' ',' ',' ','#','#',' ','#','#','#','#',' ','#',' ','#','#',' ','#',' ','#',' ','#',' ','#','#',' ','#',' ','#','#',' ',' ',' ',' ',' ',' ',' ','#'},
  ...
  bouge = ' ';
  tab1[jy][jx] = 'j';
  affiche_hard_maps(tab1);
  tab1[jy][jx] = ' ';
  move_mapb1_casu(tab1, jy, jx, bouge);                
}

void  create_mapb3(int jx, int jy) {
  static char tab2[taillebl][taillebc] = {{'#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#'},
				                         {' ',' ','#',' ',' ',' ','#',' ',' ',' ',' ',' ',' ','#','#',' ',' ',' ',' ',' ',' ','#',' ','#','#',' ',' ',' ','#',' ',' ',' ',' ',' ','#',' ',' ',' ',' ',' ',' ',' ',' ','#',' ',' ','#','#',' ',' ',' ',' ',' ',' ',' ','#','#','#',' ','#'},
				                         {'#',' ',' ',' ','#',' ',' ',' ','#','#','#',' ','#',' ','#','#',' ','#','#','#',' ',' ',' ','#',' ',' ','#',' ','#',' ','#','#','#',' ','#','#',' ','#','#','#',' ','#',' ','#','#',' ',' ',' ','#',' ','#','#','#','#',' ','#',' ',' ',' ','#'},
				                         {'#',' ','#',' ',' ','#','#',' ',' ',' ','#',' ','#',' ','#',' ',' ',' ',' ','#',' ','#','#','#','#',' ','#',' ',' ','#',' ',' ','#',' ','#',' ',' ','#',' ','#','#','#',' ','#',' ','#','#',' ','#',' ','#',' ',' ','#',' ','#','#',' ','#','#'},
				                         {'#',' ','#','#','#',' ','#','#','#','#','#',' ',' ',' ','#',' ','#','#','#','#',' ',' ',' ',' ',' ',' ','#','#',' ','#','#','#','#',' ','#',' ','#','#',' ','#',' ','#',' ','#',' ','#','#',' ','#',' ','#','#',' ',' ',' ',' ',' ',' ',' ','#'},
  ...
  bouge = ' ';
  tab2[jy][jx] = 'j';
  affiche_hard_maps(tab2);
  tab2[jy][jx] = ' ';
  move_mapb1_casu(tab2, jy, jx, bouge);              
}
